{-
  Tests/BalancedValidation.idr

  Validates our domain model against the expert-crafted "Balanced" preset
...
module Tests.BalancedValidation
...
-- ============================================================================
-- BALANCED PRESET (Ground Truth from data/presets.js)
-- ============================================================================

{-
  The expert-chosen job assignments for the "Balanced" preset:

  Vaan:      Red Battlemage + Knight
  Balthier:  Foebreaker + Bushi
  Fran:      Monk + Time Battlemage
  Basch:     Archer + Uhlan
  Ashe:      Black Mage + White Mage
...
export
balancedPreset : List CharacterBuild
balancedPreset =
  [ MkCharacterBuild Vaan RedBattlemage Knight [Mateus, Exodus] "Knight"
  , MkCharacterBuild Balthier Foebreaker Bushi [Belias] "Berserker"
  , MkCharacterBuild Fran Monk TimeBattlemage [Zeromus, Ultima, Zodiark] "Support"
  , MkCharacterBuild Basch Archer Uhlan [Adrammelech, Famfrit, Shemhazai] "Lancer"
...
runValidation : IO ()
runValidation = do
  putStrLn "BALANCED PRESET VALIDATION"
  putStrLn "=========================="
  putStrLn ""
  ...
  -- Analyze all builds
  let analyses = map analyzeBuild balancedPreset
