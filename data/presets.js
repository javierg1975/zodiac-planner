const PRESETS = {
    ...
    'Spare No Expense': {
        ...
        parties: [
            { name: 'Optimal Formation', members: ['Vaan', 'Fran', 'Penelo'], why: 'Best all-around party. Vaan (katana DPS/Holy flex), Fran (Hastega + buffs/debuffs + utility), Penelo (evasion tank + healing). Covers all roles with maximum efficiency. Fran is essential for Hastega - rotate other characters based on encounter needs.' }
        ],
        builds: [
