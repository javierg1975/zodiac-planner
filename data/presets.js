const PRESETS = {
    ...
    'Max Efficiency': {
        ...
        builds: [
            ...
            { char: 'Fran', jobs: ['Monk', 'Time Battlemage'], espers: ['Ultima', 'Zeromus', 'Zodiark'], role: 'Support Mage', why: 'Critical Trinity Node: Swiftness 3, Channeling 3, Renew access, and natural Hastega (Time Battlemage). Ultimate support powerhouse.', gambits: ['Ally: Status ≠ Haste → Hastega', 'Ally: Any → Bravery', 'Ally: HP Critical → Renew', 'Foe: HP ≥ 10000 → Expose', 'Foe: Nearest Visible → Attack'], gear: ['Dragon Whisker | Highest damage pole weapon', 'Grand Armor | Maximum physical defense for STR scaling', 'Golden Amulet | LP boost accessory', 'Ribbon | Status immunity for support role'] },
            { char: 'Basch', jobs: ['Bushi', 'Black Mage'], espers: [], role: 'Magic DPS', why: 'Bushi/Mage synergy. Katanas scale with MAG stat, optimized by Black Mage augments.', gambits: ['Self: HP < 90% → Bubble', 'Ally: Any → Berserk'], gear: ['Masamune | Katana with MAG scaling synergy', 'Black Robes | Maximizes magic and katana damage', 'Black Mask | Additional MAG boost', 'Genji Gloves | Essential 1.8x combo rate for katanas'] },
    ...
    'DPS Nuclear': {
        ...
        builds: [
            { char: 'Vaan', jobs: ['Bushi', 'Knight'], espers: ['Hashmal', 'Shemhazai'], role: 'Attacker', why: 'Optimized for physical combos and Holy-elemental dominance. Hashmal unlocks Knight Curaja/Bravery/Faith. Shemhazai gives Knight Potion Lore 2 and Bushi Shield Block for versatility.', gambits: ['Self: HP < 90% → Bubble', 'Ally: Any → Berserk'], gear: ['Masamune | Katana with MAG scaling for Bushi', 'Grand Armor | Maximum physical defense', 'Genji Gloves | Essential 1.8x combo rate boost', 'Berserk Bracers | Permanent Berserk status'] },
            ...
            { char: 'Ashe', jobs: ['Black Mage', 'White Mage'], espers: ['Chaos'], role: 'Mage', why: 'Ultimate Magick character with all magic schools naturally. Chaos gives White Mage excellent weapons (Defender, Save the Queen) and HP +310. Black Mage/White Mage combo has natural access to all spells. White Mage has Haste (single target) but NOT Hastega - rely on Fran for party-wide Hastega.', gambits: ['Ally: HP < 60% → Curaja', 'Ally: HP < 40% → Cura', 'Foe: Weak Element → -ga spell', 'Foe: HP ≥ 10000 → Scathe', 'Foe: Undead → Holy'], gear: ['Staff of the Magi | Best staff for magic power', 'Defender | Excellent sword from Chaos', 'Black Robes | Maximizes all magic damage', 'Circlet | MAG boost headgear', 'Sage\'s Ring | MP regeneration for casters'] },
            { char: 'Penelo', jobs: ['White Mage', 'Shikari'], espers: ['Cuchulainn'], role: 'Healer', why: 'High-evasion healer designed for long fights and party stability. Cuchulainn unlocks Shikari Protectga/Shellga for party-wide defense buffs.', gambits: ['Ally: Any Status → Remedy', 'Ally: HP < 70% → Curaga', 'Ally: HP Critical → Phoenix Down', 'Ally: Any → Protectga', 'Self: HP < 40% → Decoy', 'Foe: Nearest Visible → Attack'], gear: ['Main Gauche | 50% evasion dagger for survival', 'Crystal Shield | Best shield for evasion tank', 'Rubber Suit | Thunder immunity light armor', 'Ribbon | Status immunity for healer'] }
        ]
    },
    'Balanced': {
        shortName: 'Balanced',
        ...
        builds: [
            ...
            { char: 'Basch', jobs: ['Archer', 'Uhlan'], espers: ['Adrammelech', 'Shemhazai', 'Famfrit'], role: 'Lancer', why: 'Shemhazai unlocks critical Heavy Armor for Archer (Dragon/Grand/Maximilian). Adrammelech gives Uhlan Battle Lore. Famfrit provides HP bonuses and Uhlan Potion Lore 3. Linear weapon progression with solid defensive scaling.', gambits: ['Self: HP < 90% → Bubble', 'Ally: Any → Berserk'], gear: ['Zodiac Spear | Best spear in game', 'Perseus Bow | Best bow for ranged damage', 'Grand Armor | Heavy armor from Shemhazai', 'Germinas Boots | Essential for bow damage boost', 'Berserk Bracers | Permanent Berserk status'] },
            { char: 'Ashe', jobs: ['Black Mage', 'White Mage'], espers: ['Chaos'], role: 'Mage', why: 'Primary magus character with natural access to all magic schools (Black, White, Time, Green). Chaos provides excellent weapons (Defender, Save the Queen) and HP boost. White Mage has Haste (single target) but NOT Hastega - Fran (Monk/Time Battlemage) provides party-wide Hastega.', gambits: ['Ally: HP < 60% → Curaja', 'Ally: HP < 40% → Cura', 'Foe: Flying → Aeroga', 'Foe: HP ≥ 10000 → Ardor', 'Foe: Nearest Visible → Attack'], gear: ['Staff of the Magi | Best staff for magic power', 'Defender | Excellent sword from Chaos', 'Black Robes | Maximizes all magic damage', 'Circlet | MAG boost headgear', 'Sage\'s Ring | MP regeneration for casters'] },
            { char: 'Penelo', jobs: ['White Mage', 'Shikari'], espers: ['Cuchulainn'], role: 'Healer', why: 'Evasion tank healer. Cuchulainn unlocks Shikari Protectga/Shellga for party-wide defense. Main Gauche + shields for 90%+ evasion. White Mage provides full healing suite naturally.', gambits: ['Ally: Any Status → Remedy', 'Ally: HP < 70% → Curaga', 'Ally: HP Critical → Phoenix Down', 'Ally: Any → Protectga', 'Self: HP < 40% → Decoy', 'Foe: Nearest Visible → Attack'], gear: ['Main Gauche | 50% evasion dagger for survival', 'Crystal Shield | Best shield for evasion tank', 'Demon Shield | Alternative shield with immunities', 'Ribbon | Status immunity for healer role'] }
        ]
    },
    'Leader Trinity': {
        shortName: 'Trinity',
        ...
        builds: [
            ...
            { char: 'Fran', jobs: ['Monk', 'Time Battlemage'], espers: ['Ultima', 'Zeromus', 'Zodiark'], role: 'Support', why: 'Buff and debuff specialist with natural Hastega (Time Battlemage). Primary source of Expose and Renew. Ultima unlocks Monk Swiftness x2, Zeromus unlocks Monk Channeling (infinite MP), Zodiark unlocks Monk Renew. Complete utility powerhouse with Hastega + Renew + Swiftness + Channeling.', gambits: ['Ally: Status ≠ Haste → Hastega', 'Ally: Any → Bravery', 'Ally: HP Critical → Renew', 'Foe: HP ≥ 10000 → Expose', 'Foe: Nearest Visible → Attack'], gear: ['Dragon Whisker | Highest damage pole weapon', 'Grand Armor | Maximum physical defense for STR scaling', 'Ribbon | Status immunity for support role', 'Golden Amulet | LP boost for faster progression'] },
            ...
            { char: 'Ashe', jobs: ['Black Mage', 'White Mage'], espers: ['Zalera'], role: 'Magick Support', why: 'Complete magic caster with natural access to Black, White, Time, and Green magic schools. Zalera gives Black Mage Steal and Poach for utility. White Mage has Haste (single target) but NOT Hastega - rely on Fran for party-wide Hastega.', gambits: ['Ally: HP < 60% → Curaja', 'Ally: HP < 40% → Cura', 'Foe: Weak Element → -ga spell', 'Foe: HP ≥ 10000 → Scathe', 'Foe: Nearest Visible → Attack'], gear: ['Staff of the Magi | Best staff for magic power', 'Black Robes | Maximizes all magic damage', 'Circlet | MAG boost headgear', 'Sage\'s Ring | MP regeneration for casters'] },
    ...
    'Yiazmat Specialist': {
        ...
        builds: [
            ...
            { char: 'Basch', jobs: ['Archer', 'Uhlan'], espers: ['Adrammelech', 'Shemhazai'], role: 'Ranged Support', why: 'Safe ranged attacks from distance. Provides backup physical DPS during relief phases. Adrammelech gives Uhlan Battle Lore. Shemhazai unlocks critical Heavy Armor for Archer (Dragon/Grand/Maximilian). Bow/spear versatility for different phases.', gambits: ['Foe: Yiazmat → Attack', 'Self: HP < 90% → Bubble', 'Ally: Any → Bravery', 'Foe: HP ≥ 10000 → Expose'], gear: ['Perseus Bow | Best bow for ranged damage', 'Zodiac Spear | Alternative spear option', 'Grand Armor | Heavy Armor unlocked by Shemhazai', 'Ribbon | Status immunity', 'Bubble Belt | HP threshold'] }
        ]
    },
    'Lore Friendly': {
        shortName: 'Lore',
    ...
    'Spare No Expense': {
        ...
        parties: [
            { name: 'Vanguard Strike', members: ['Vaan', 'Fran', 'Penelo'], why: 'Balanced assault. Vaan (Berserk katana/Excalibur flex), Fran (Hastega source + buff engine + Genji pole), Penelo (evasion tank healer). Fran provides party-wide Hastega.' },
            { name: 'Heavy Artillery', members: ['Basch', 'Fran', 'Ashe'], why: 'Break + complete magic. Basch (full Break suite + Zodiac Spear), Fran (Hastega + Expose), Ashe (all magic schools naturally). Fran maintains Hastega uptime.' },
            { name: 'Elemental Onslaught', members: ['Balthier', 'Fran', 'Ashe'], why: 'Fire synergy team. Balthier (Burning Bow + Ardor), Ashe (all elemental spells + Ardor), Fran (Hastega + buffs). Fran provides Hastega while fire DPS melts enemies.' }
        ],
        builds: [
            ...
            { char: 'Balthier', jobs: ['Archer', 'Red Battlemage'], espers: ['Shemhazai', 'Cuchulainn'], role: 'Elementalist', why: 'Burning Bow + Ardor synergy. Shemhazai unlocks critical Archer Heavy Armor 10-12 + Firaga (MANDATORY for Archer), Cuchulainn unlocks Red Battlemage tier 3 elemental spells (Firaga/Thundaga/Blizzaga/Sleepga - MANDATORY for Red Battlemage). Perseus Bow for general use, Burning Bow + Oil + Ardor for massive fire damage combos.', gambits: ['Foe: Status ≠ Oil → Oil', 'Foe: Oiled → Ardor', 'Foe: Flying → Firaga', 'Foe: HP ≥ 10000 → Shear', 'Ally: HP < 50% → Cura', 'Foe: Nearest Visible → Attack'], gear: ['Perseus Bow | Best bow for endgame', 'Burning Bow | Fire element for Ardor combos', 'Grand Armor | Heavy armor from Shemhazai', 'Germinas Boots | +50 Speed for bow damage', 'Ribbon | Trial Mode status immunity', 'Golden Amulet | LP boost for progression'] },
