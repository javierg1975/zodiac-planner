const PRESETS = {
    ...
    'Max Efficiency': {
        ...
        builds: [
            ...
            { char: 'Fran', jobs: ['Monk', 'Time Battlemage'], espers: ['Zeromus', 'Ultima', 'Zodiark'], role: 'Support Mage', why: 'Critical Trinity Node: Swiftness 3, Channeling 3, Renew access, and natural Hastega (Time Battlemage). Ultimate support powerhouse.', gambits: ['Ally: Status ≠ Haste → Hastega', 'Ally: Any → Bravery', 'Ally: HP Critical → Renew', 'Foe: HP ≥ 10000 → Expose', 'Foe: Nearest Visible → Attack'], gear: ['Kanya | Best pole (109 ATK, Holy element, full 1.25x Genji bonus)', 'Grand Armor | Heavy Armor 12 for STR scaling', 'Golden Amulet | LP +10% boost', 'Ribbon | Status immunity'] },
    ...
    'DPS Nuclear': {
        ...
        builds: [
            ...
            { char: 'Balthier', jobs: ['Monk', 'Foebreaker'], espers: ['Zeromus', 'Ultima', 'Zodiark'], role: 'Brawler', why: 'Dual-Heavy synergy. Leverages all 16 Battle Lores for theoretical maximum physical damage. Ultima unlocks Monk Swiftness x2 (critical for DPS), Zeromus unlocks Monk Channeling (infinite MP), Zodiark unlocks Monk Renew for self-sustain.', gambits: ['Foe: HP ≥ 10000 → Expose', 'Foe: Status ≠ Shattered → Shear', 'Ally: Any → Berserk'], gear: ['Kanya | Best pole (109 ATK, Holy element, full 1.25x Genji bonus)', 'Grand Armor | Maximum physical defense', 'Genji Gloves | Essential 1.25x combo rate for Kanya', 'Berserk Bracers | Permanent Berserk status'] },
    ...
    'Leader Trinity': {
        ...
        builds: [
            ...
            { char: 'Fran', jobs: ['Monk', 'Time Battlemage'], espers: ['Zeromus', 'Ultima', 'Zodiark'], role: 'Support', why: 'Buff and debuff specialist with natural Hastega (Time Battlemage). Primary source of Expose and Renew. Ultima unlocks Monk Swiftness x2, Zeromus unlocks Monk Channeling (infinite MP), Zodiark unlocks Monk Renew. Complete utility powerhouse with Hastega + Renew + Swiftness + Channeling.', gambits: ['Ally: Status ≠ Haste → Hastega', 'Ally: Any → Bravery', 'Ally: HP Critical → Renew', 'Foe: HP ≥ 10000 → Expose', 'Foe: Nearest Visible → Attack'], gear: ['Kanya | Best pole (109 ATK, Holy element, full 1.25x Genji bonus)', 'Grand Armor | Maximum physical defense for STR scaling', 'Ribbon | Status immunity for support role', 'Golden Amulet | LP boost for faster progression'] },
