const PRESETS = {
    ...
    'Max Efficiency': {
        ...
        builds: [
            ...
            { char: 'Penelo', jobs: ['White Mage', 'Shikari'], espers: ['Cuchulainn'], role: 'Evasion Healer', why: 'Maximum-tier evasion via Main Gauche and Shields. Cuchulainn unlocks Shikari Protectga/Shellga for party-wide defense. White Mage has natural Haste (single target) but NOT Hastega - rely on Fran (Time Battlemage) for party-wide Hastega.', gambits: ['Ally: HP < 70% → Curaga', 'Ally: HP Critical → Phoenix Down', 'Ally: Any → Protectga'], gambitStrategy: 'Healer survives via evasion. Dead healer = party wipe. Phoenix Down prevents cascading failures.', gear: ['Main Gauche | 50% evasion dagger', 'Crystal Shield | Highest evasion shield (90% total with Main Gauche)', 'Demon Shield | Alternative for status-heavy encounters', 'Ribbon | Status immunity'] }
        ]
    },
    'DPS Nuclear': {
        shortName: 'Nuclear',
        ...
        builds: [
            ...
            { char: 'Penelo', jobs: ['White Mage', 'Shikari'], espers: ['Cuchulainn'], role: 'Healer', why: 'High-evasion healer designed for long fights and party stability. Cuchulainn unlocks Shikari Protectga/Shellga for party-wide defense buffs.', gambits: ['Ally: HP < 70% → Curaga', 'Ally: HP Critical → Phoenix Down', 'Ally: Any → Protectga'], gambitStrategy: 'Evasion healer can\'t heal when dead. Phoenix Down stops chain deaths. Protectga prevents damage cascades.', gear: ['Main Gauche | 50% evasion dagger for survival', 'Crystal Shield | Best shield for evasion tank', 'Rubber Suit | Situational Thunder immunity (vs specific bosses)', 'Ribbon | Status immunity for healer'] }
        ]
    },
    'Balanced': {
        shortName: 'Balanced',
        ...
        builds: [
            ...
            { char: 'Penelo', jobs: ['White Mage', 'Shikari'], espers: ['Cuchulainn'], role: 'Healer', why: 'Evasion tank healer. Cuchulainn unlocks Shikari Protectga/Shellga for party-wide defense. Main Gauche + shields for 90%+ evasion. White Mage provides full healing suite naturally.', gambits: ['Ally: HP < 70% → Curaga', 'Ally: HP Critical → Phoenix Down', 'Ally: Any → Protectga'], gambitStrategy: '90% dodge chance keeps dedicated healer alive. Dead healer = party wipe. Phoenix Down insurance.', gear: ['Main Gauche | 50% evasion dagger for survival', 'Crystal Shield | Primary shield (90% evasion with Main Gauche)', 'Demon Shield | Situational for status-heavy encounters', 'Ribbon | Status immunity for healer role'] }
        ]
    },
    'Leader Trinity': {
        shortName: 'Trinity',
    ...
    'Lore Friendly': {
        ...
        builds: [
            ...
            { char: 'Penelo', jobs: ['White Mage', 'Monk'], espers: ['Ultima'], role: 'White Mage', why: 'Fast healer with strong physical backup. Ultima unlocks Monk Swiftness x2 for enhanced action speed. White Mage provides full healing suite, Monk provides pole damage and durability.', gambits: ['Ally: HP < 70% → Curaga', 'Ally: HP Critical → Phoenix Down', 'Ally: Any → Protect'], gambitStrategy: 'Dancer background fits Monk mobility. Swiftness 3 represents agility-based combat style.', gear: ['Kanya | Best pole (109 ATK, Holy element, full 1.25x Genji bonus)', 'White Robes | Healing power boost', 'Whale Whisker | Non-elemental alternative (108 ATK, for Holy-absorbing enemies)', 'Opal Ring | Dark/Thunder immunity accessory'] }
        ]
    },
    'Spare No Expense': {
        shortName: 'Ultimate',
